...
<main class="p-home">
  ...
  <section data-bg-color="yellow" class="home-about" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/img/bg-img.jpg')">
    <div class="wrapper">
      ...
      <p id="about-desc" class="mt-11">
        私たちは、自動車販売と整備を通じて、お客様との対等な 50:50の関係を大切にし、<br>
        共に最適なカーライフを実現します。<br>
        思いやりを基にしたサービス種神と企業努力を惜します、<br>
        日々品質の向上に努めることでお客様との縁を繋いで来ました。<br>
        <br>
        急なトラブルにも即時対応できる体制を整え、<br>
        お客様の安心と安全を最優先に考えたサービスをご提供。<br>
        また、専任のコンセルジュがご相談から購入後のサポートまで丁寧に対応し、<br>
        快適なドライブ体験をお約束します。
      </p>
      <a class="btn btn--secondary group mx-auto mt-13.75" href="<?php echo home_url(); ?>/about">
        <span>VIEW MORE</span>
  ...
  <section data-bg-color="black" class="home-virtual">
      <h2 class="relative">
      ...
      ?>
      <div class="wrapper mt-12.5" x-data="{data: 0, showCard: false, selectedData: 0}">
        <div class="content">
